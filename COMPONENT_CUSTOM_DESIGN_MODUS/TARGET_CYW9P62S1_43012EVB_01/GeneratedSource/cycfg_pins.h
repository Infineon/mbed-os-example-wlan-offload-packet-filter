...
#define CYBSP_WIFI_HOST_WAKE_PORT GPIO_PRT6
#define CYBSP_WIFI_HOST_WAKE_PORT_NUM 6U
#define CYBSP_WIFI_HOST_WAKE_PIN 0U
#define CYBSP_WIFI_HOST_WAKE_NUM 0U
...
#endif
#define CYBSP_WIFI_HOST_WAKE_HSIOM ioss_0_port_6_pin_0_HSIOM
#define CYBSP_WIFI_HOST_WAKE_IRQ ioss_interrupts_gpio_6_IRQn
#if defined (CY_USING_HAL)
	#define CYBSP_WIFI_HOST_WAKE_HAL_PORT_PIN P6_0
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
